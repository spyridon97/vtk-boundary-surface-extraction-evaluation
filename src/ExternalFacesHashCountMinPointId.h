...
public:
    ...
    YamlWriter& log)
  {
    ...
    timer.Stop();
    allocationTime += timer.GetElapsedTime();
    ...
    vtkm::worklet::DispatcherMapTopology<FaceHash> faceHashDispatcher;
    timer.Start();
    ...
    log.AddDictionaryEntry("seconds-allocations", allocationTime);
